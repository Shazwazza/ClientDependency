...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <CD:JsInclude ID="JsInclude3" runat="server" FilePath="AnotherTest.js" PathNameAlias="Scripts" Group="1" Priority="1" />
    <CD:JsInclude ID="JsInclude2" runat="server" FilePath="jquery-ui-1.8.13.custom.min.js" PathNameAlias="Scripts" Group="1" />
    <CD:JsInclude ID="JsInclude1" runat="server" FilePath="jquery-1.3.2.min.js" PathNameAlias="Scripts" Group="1" />
