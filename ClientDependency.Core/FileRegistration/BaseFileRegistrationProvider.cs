...
{
    public abstract class BaseFileRegistrationProvider
    {
        /// <summary>
        ...
        {
            if (ClientDependencySettings.Instance.Version == null)
                return url;
            if ((http.IsDebuggingEnabled || !EnableCompositeFiles)
            ...
            {
                if (url.EndsWith(ClientDependencySettings.Instance.Version))
                    return url;
